...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldReturnEmployeesWithCommission()
    {
        ...
        var result = from emp in emps where emp.Comm != null select new { emp.EName, Comm = emp.Comm }; 
    ...
    public void ShouldMatchEmployeeToSalaryGrade()
    {
        ...
        var result = emps.Join(grades, e => e.Sal, g => g.Losal, (e, g) => new { EName = e.EName, Grade = g.Grade });
    ...
    public void ShouldCalculateAverageSalaryPerDept()
    {
        ...
        var result = from emp in emps group emp by emp.DeptNo into g select new { DeptNo = g.Key, AvgSal = g.Average(e => e.Sal) }; 
    ...
    public void ShouldReturnEmployeesEarningMoreThanDeptAverage()
    {
        ...
        var result = emps.Where(emp => emp.Sal > emps.Where(e => e.DeptNo == emp.DeptNo).Average(e => e.Sal)).Select(emp => emp.EName).ToList();
